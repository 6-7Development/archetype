          ...
          <ScrollArea className="max-h-[200px]">
            <div className="space-y-1.5">
              ...
              {changes.created.map((filename) => (
                ...
                >
                  <FilePlus className="w-4 h-4 mt-0.5 flex-shrink-0 text-green-600 dark:text-green-400" />
                  <span className="flex-1 font-mono text-xs break-all">{filename}</span>
                  <Badge
                    variant="outline"
                    className="flex-shrink-0 text-xs border-green-500/30 text-green-600 dark:text-green-400"
                  >
                    NEW
                  </Badge>
                </div>
              ...
              {changes.modified.map((filename) => (
                ...
                >
                  <FileEdit className="w-4 h-4 mt-0.5 flex-shrink-0 text-yellow-600 dark:text-yellow-400" />
                  <span className="flex-1 font-mono text-xs break-all">{filename}</span>
                  <Badge
                    variant="outline"
                    className="flex-shrink-0 text-xs border-yellow-500/30 text-yellow-600 dark:text-yellow-400"
                  >
                    MODIFIED
                  </Badge>
                </div>
              ...
              {changes.deleted.map((filename) => (
                ...
                >
                  <FileX className="w-4 h-4 mt-0.5 flex-shrink-0 text-red-600 dark:text-red-400" />
                  <span className="flex-1 font-mono text-xs break-all line-through opacity-70">
                    {filename}
                  </span>
                  <Badge
                    variant="outline"
                    className="flex-shrink-0 text-xs border-red-500/30 text-red-600 dark:text-red-400"
                  >
                    DELETED
                  </Badge>
                </div>
