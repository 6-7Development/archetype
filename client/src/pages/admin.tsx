  ...
  return (
    <div className="container mx-auto p-6 space-y-6" data-testid="admin-dashboard">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold" data-testid="heading-admin">Admin Dashboard - DEPLOYMENT TEST ✓</h1>
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-muted-foreground mt-1">
                            LomuAI can now modify platform files. Changes will be committed to GitHub and auto-deployed.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="rounded-lg bg-muted p-4 space-y-2" data-testid="maintenance-disabled-info">
                      <div className="flex items-start gap-2">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-muted-foreground mt-1">
                            Enable maintenance mode to allow LomuAI to modify platform files and commit to GitHub.
                          </p>
                        </div>
                      </div>
                    </div>
