        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <Card className="p-6 space-y-6">
            <section className="space-y-3">
              ...
              <p className="text-muted-foreground">
                By accessing and using the LomuAI platform, you accept and agree to be bound by 
            ...
            <section className="space-y-3">
              ...
              <p className="text-muted-foreground">
                ...
                or software) on LomuAI for personal, non-commercial transitory viewing only. This is 
            ...
            <section className="space-y-3">
              ...
              <p className="text-muted-foreground">
                The materials on LomuAI are provided "as is". LomuAI makes no warranties, expressed 
            ...
            <section className="space-y-3">
              ...
              <p className="text-muted-foreground">
                In no event shall LomuAI or its suppliers be liable for any damages (including, 
                without limitation, damages for loss of data or profit, or due to business interruption) 
                arising out of the use or inability to use the materials on LomuAI.
              </p>
            </section>
            ...
            <section className="space-y-3">
              ...
              <p className="text-muted-foreground">
                The materials appearing on LomuAI could include technical, typographical, or 
                photographic errors. LomuAI does not warrant that any of the materials on LomuAI 
            ...
            <section className="space-y-3">
              ...
              <p className="text-muted-foreground">
                LomuAI may revise these Terms of Service for the platform at any time without notice. 
