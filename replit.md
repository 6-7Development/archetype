...
- **Complete Tool Inventory (2024-11-03):** System prompt now documents ALL 42 available tools including previously missing project file operations (readProjectFile, writeProjectFile, createProjectFile, deleteProjectFile, listProjectDirectory), platform tools (createPlatformFile, deletePlatformFile), and diagnostic tools (perform_diagnosis, read_logs). LomuAI now has complete visibility into all capabilities.
