import { UserIntent } from '@shared/chatConfig';

export function classifyUserIntent_DEPRECATED(message: string): UserIntent {
...
export function getMaxIterationsForIntent_DEPRECATED(intent: UserIntent): number {
  return 30;
}
